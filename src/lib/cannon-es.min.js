...
class Mat3 {
  ...
  solve(e, t) {
    ...
    if (
      ((t.z = s[11] / s[10]),
      (t.y = (s[7] - s[6] * t.z) / s[5]),
      (t.x = (s[3] - s[2] * t.z - s[1] * t.y) / s[0]),
      isNaN(t.x) || isNaN(t.y) || isNaN(t.z) || t.x === 1 / 0 || t.y === 1 / 0 || t.z === 1 / 0)
    )
...
class Vec3 {
  ...
  tangents(e, t) {
    ...
    if (s > 0) {
      ...
      Math.abs(i.x) < 0.9 ? (n.set(1, 0, 0), i.cross(n, e)) : (n.set(0, 1, 0), i.cross(n, e)),
        i.cross(e, t);
  ...
  almostEquals(e, t) {
    return (
      void 0 === t && (t = 1e-6),
      !(Math.abs(this.x - e.x) > t || Math.abs(this.y - e.y) > t || Math.abs(this.z - e.z) > t)
    );
  }
  almostZero(e) {
    return (
...
class AABB {
  ...
  setFromPoints(e, t, s, i) {
    ...
    return (
      ...
      i && ((o.x -= i), (o.y -= i), (o.z -= i), (n.x += i), (n.y += i), (n.z += i)),
      this
    );
  }
  copy(e) {
...
class Quaternion {
  ...
  setFromAxisAngle(e, t) {
    ...
    return (
      (this.x = e.x * s), (this.y = e.y * s), (this.z = e.z * s), (this.w = Math.cos(0.5 * t)), this
    );
  }
  toAxisAngle(e) {
  ...
  normalize() {
    ...
    return (
      0 === e
        ...
        : ((e = 1 / e), (this.x *= e), (this.y *= e), (this.z *= e), (this.w *= e)),
      this
    );
  }
  normalizeFast() {
  ...
  toEuler(e, t) {
    ...
    if ('YZX' !== t) throw new Error(`Euler order ${t} not supported yet.`);
    {
      const e = n * r + a * l;
      if (
        (e > 0.499 && ((s = 2 * Math.atan2(n, l)), (i = Math.PI / 2), (o = 0)),
        e < -0.499 && ((s = -2 * Math.atan2(n, l)), (i = -Math.PI / 2), (o = 0)),
        void 0 === s)
      ) {
        const t = n * n,
          c = r * r,
          h = a * a;
        (s = Math.atan2(2 * r * l - 2 * n * a, 1 - 2 * c - 2 * h)),
          (i = Math.asin(2 * e)),
          (o = Math.atan2(2 * n * l - 2 * r * a, 1 - 2 * t - 2 * h));
      }
    }
    (e.y = s), (e.z = i), (e.x = o);
  }
...
class Shape {
  constructor(e) {
    void 0 === e && (e = {}),
      ...
      (this.collisionResponse = !e.collisionResponse || e.collisionResponse),
...
class ConvexPolyhedron extends Shape {
  ...
  computeNormals() {
    ...
    for (let e = 0; e < this.faces.length; e++) {
      ...
      if (t.dot(s) < 0) {
        ...
        for (let t = 0; t < this.faces[e].length; t++)
          console.warn(
            `.vertices[${this.faces[e][t]}] = Vec3(${this.vertices[this.faces[e][t]].toString()})`
          );
      }
    }
  }
  ...
  clipFaceAgainstHull(e, t, s, i, o, n, r) {
    ...
    const w = v.faces[x];
    w.connectedFaces = [];
    for (let e = 0; e < v.faces.length; e++)
      for (let t = 0; t < v.faces[e].length; t++)
        -1 !== w.indexOf(v.faces[e][t]) &&
          e !== x &&
          -1 === w.connectedFaces.indexOf(e) &&
          w.connectedFaces.push(e);
    const b = w.length;
    for (let e = 0; e < b; e++) {
  ...
  calculateWorldAABB(e, t, s, i) {
    ...
    for (let s = 0; s < o.length; s++) {
      ...
      const i = d;
      (void 0 === n || i.x < n) && (n = i.x),
        (void 0 === l || i.x > l) && (l = i.x),
        (void 0 === r || i.y < r) && (r = i.y),
...
class Box extends Shape {
  ...
  getSideNormals(e, t) {
    ...
    if (
      ...
      for (let e = 0; e !== s.length; e++) t.vmult(s[e], s[e]);
    return s;
  }
  volume() {
  ...
  forEachWorldCorner(e, t, s) {
    ...
    for (let i = 0; i < o.length; i++)
      worldCornerTempPos.set(o[i][0], o[i][1], o[i][2]),
        t.vmult(worldCornerTempPos, worldCornerTempPos),
        e.vadd(worldCornerTempPos, worldCornerTempPos),
        s(worldCornerTempPos.x, worldCornerTempPos.y, worldCornerTempPos.z);
  }
  calculateWorldAABB(e, t, s, i) {
    const o = this.halfExtents;
    worldCornersTemp[0].set(o.x, o.y, o.z),
      worldCornersTemp[1].set(-o.x, o.y, o.z),
      worldCornersTemp[2].set(-o.x, -o.y, o.z),
      worldCornersTemp[3].set(-o.x, -o.y, -o.z),
      worldCornersTemp[4].set(o.x, -o.y, -o.z),
      worldCornersTemp[5].set(o.x, o.y, -o.z),
      worldCornersTemp[6].set(-o.x, o.y, -o.z),
      worldCornersTemp[7].set(o.x, -o.y, o.z);
...
class Body extends EventTarget {
  constructor(e) {
    void 0 === e && (e = {}),
      ...
      (this.collisionFilterGroup =
        'number' == typeof e.collisionFilterGroup ? e.collisionFilterGroup : 1),
      (this.collisionFilterMask =
        'number' == typeof e.collisionFilterMask ? e.collisionFilterMask : -1),
  ...
  wakeUp() {
    ...
    (this.sleepState = Body.AWAKE),
      (this.wakeUpAfterNarrowphase = !1),
      e === Body.SLEEPING && this.dispatchEvent(Body.wakeupEvent);
  }
  sleep() {
  ...
  pointToWorldFrame(e, t) {
    return (
      void 0 === t && (t = new Vec3()), this.quaternion.vmult(e, t), t.vadd(this.position, t), t
    );
  }
  vectorToWorldFrame(e, t) {
    return void 0 === t && (t = new Vec3()), this.quaternion.vmult(e, t), t;
  ...
  updateAABB() {
    ...
    for (let c = 0; c !== i; c++) {
      ...
      r.vmult(t[c], o),
        ...
        r.mult(s[c], n),
        i.calculateWorldAABB(o, n, l.lowerBound, l.upperBound),
  ...
  updateInertiaWorld(e) {
    ...
    if (t.x !== t.y || t.y !== t.z || e) {
      const e = uiw_m1,
        s = uiw_m2;
      e.setRotationFromQuaternion(this.quaternion),
        e.transpose(s),
        e.scale(t, e),
        e.mmult(s, this.invInertiaWorld);
    } else;
  }
  applyForce(e, t) {
  ...
  applyTorque(e) {
    this.type === Body.DYNAMIC &&
      (this.sleepState === Body.SLEEPING && this.wakeUp(), this.torque.vadd(e, this.torque));
  }
  applyImpulse(e, t) {
    if ((void 0 === t && (t = new Vec3()), this.type !== Body.DYNAMIC)) return;
    this.sleepState === Body.SLEEPING && this.wakeUp();
  ...
  updateMassProperties() {
    ...
    this.updateAABB(),
      ...
      Box.calculateInertia(e, this.mass, t),
      this.invInertia.set(
        t.x > 0 && !s ? 1 / t.x : 0,
        t.y > 0 && !s ? 1 / t.y : 0,
        t.z > 0 && !s ? 1 / t.z : 0
  ...
  integrate(e, t, s) {
    ...
    const u = h.elements,
      ...
      y = a.y * m.y,
      g = a.z * m.z;
    (o.x += e * (u[0] * v + u[1] * y + u[2] * g)),
      (o.y += e * (u[3] * v + u[4] * y + u[5] * g)),
      (o.z += e * (u[6] * v + u[7] * y + u[8] * g)),
      (n.x += i.x * e),
      (n.y += i.y * e),
      (n.z += i.z * e),
...
class Broadphase {
  ...
  needBroadphaseCollision(e, t) {
    return (
      ...
      ((0 == (e.type & Body.STATIC) && e.sleepState !== Body.SLEEPING) ||
        (0 == (t.type & Body.STATIC) && t.sleepState !== Body.SLEEPING))
    );
  }
...
class GridBroadphase extends Broadphase {
  constructor(e, t, s, i, o) {
    void 0 === e && (e = new Vec3(100, 100, 100)),
      void 0 === t && (t = new Vec3(-100, -100, -100)),
      void 0 === s && (s = 10),
      void 0 === i && (i = 10),
      void 0 === o && (o = 10),
      super(),
  ...
  collisionPairs(e, t, s) {
    ...
    for (let e = 0; e !== o; e++)
      for (let o = 0; o !== e; o++)
        (n = i[e]),
          (r = i[o]),
          this.needBroadphaseCollision(n, r) && this.intersectionTest(n, r, t, s);
  }
  aabbQuery(e, t, s) {
    void 0 === s && (s = []);
...
class Ray {
  ...
  intersectWorld(e, t) {
    return (
      ...
      (this.checkCollisionResponse =
        void 0 === t.checkCollisionResponse || t.checkCollisionResponse),
  ...
  intersectBody(e, t) {
    ...
    for (let t = 0, n = e.shapes.length; t < n; t++) {
      const n = e.shapes[t];
      if (
        (!s || n.collisionResponse) &&
        (e.quaternion.mult(e.shapeOrientations[t], o),
        e.quaternion.vmult(e.shapeOffsets[t], i),
        i.vadd(e.position, i),
        this.intersectShape(n, o, i, e),
  ...
  _intersectHeightfield(e, t, s, i, o) {
    ...
    n.from.copy(this.from),
      n.to.copy(this.to),
      Transform.pointToLocalFrame(s, t, n.from, n.from),
      Transform.pointToLocalFrame(s, t, n.to, n.to),
      n.updateDirection();
    ...
    for (let r = a; r < c; r++)
      for (let a = l; a < h; a++) {
        ...
        if ((e.getAabbAtIndex(r, a, d), d.overlapsRay(n))) {
          if (
            (e.getConvexTrianglePillar(r, a, !1),
            Transform.pointToWorldFrame(s, t, e.pillarOffset, worldPillarOffset),
            ...
            return;
          e.getConvexTrianglePillar(r, a, !0),
            Transform.pointToWorldFrame(s, t, e.pillarOffset, worldPillarOffset),
            this._intersectConvex(
              e.pillarConvex,
              t,
  ...
  _intersectSphere(e, t, s, i, o) {
    ...
    if (!(h < 0))
      if (0 === h)
        n.lerp(r, h, d), d.vsub(s, p), p.normalize(), this.reportIntersection(p, d, o, i, -1);
      else {
        ...
        if (
          (e >= 0 &&
            e <= 1 &&
            (n.lerp(r, e, d), d.vsub(s, p), p.normalize(), this.reportIntersection(p, d, o, i, -1)),
          this.result.shouldStop)
        )
          return;
        t >= 0 &&
          t <= 1 &&
          (n.lerp(r, t, d), d.vsub(s, p), p.normalize(), this.reportIntersection(p, d, o, i, -1));
      }
  }
  _intersectConvex(e, t, s, i, o, n) {
    ...
    for (let e = 0; !f.shouldStop && e < x; e++) {
      ...
      const S = r.dot(l) / B;
      if (!(S < 0)) {
        m.scale(S, intersectPoint),
          intersectPoint.vadd(v, intersectPoint),
          a.copy(p[y[0]]),
          w.vmult(a, a),
          _.vadd(a, a);
        for (let e = 1; !f.shouldStop && e < y.length - 1; e++) {
          ...
          (!Ray.pointInTriangle(intersectPoint, a, b, c) &&
            ...
            t > g ||
            this.reportIntersection(r, intersectPoint, o, i, n);
        }
      }
    }
  }
  _intersectTrimesh(e, t, s, i, o, n) {
    ...
    h.position.copy(s),
      h.quaternion.copy(t),
      Transform.vectorToLocalFrame(s, t, w, p),
      Transform.pointToLocalFrame(s, t, x, u),
      Transform.pointToLocalFrame(s, t, f, m),
      (m.x *= e.scale.x),
      (m.y *= e.scale.y),
      (m.z *= e.scale.z),
      (u.x *= e.scale.x),
    ...
    for (let n = 0, h = l.length; !this.result.shouldStop && n !== h; n++) {
      ...
      const m = p.dot(r),
        x = r.dot(d) / m;
      if (x < 0) continue;
      p.scale(x, intersectPoint),
        intersectPoint.vadd(u, intersectPoint),
        e.getVertex(g[3 * h + 1], b),
        e.getVertex(g[3 * h + 2], c);
      const f = intersectPoint.distanceSquared(u);
      (!Ray.pointInTriangle(intersectPoint, b, a, c) &&
        !Ray.pointInTriangle(intersectPoint, a, b, c)) ||
        f > _ ||
        (Transform.vectorToWorldFrame(t, r, y),
        Transform.pointToWorldFrame(s, t, intersectPoint, v),
        this.reportIntersection(y, v, o, i, h));
    }
    l.length = 0;
  }
...
class SAPBroadphase extends Broadphase {
  static checkBounds(e, t, s) {
    let i, o;
    0 === s
      ? ((i = e.position.x), (o = t.position.x))
      : 1 === s
      ? ((i = e.position.y), (o = t.position.y))
      : 2 === s && ((i = e.position.z), (o = t.position.z));
  ...
  static insertionSortX(e) {
    for (let t = 1, s = e.length; t < s; t++) {
      const s = e[t];
      let i;
      for (i = t - 1; i >= 0 && !(e[i].aabb.lowerBound.x <= s.aabb.lowerBound.x); i--)
        e[i + 1] = e[i];
      e[i + 1] = s;
    }
    return e;
  ...
  static insertionSortY(e) {
    for (let t = 1, s = e.length; t < s; t++) {
      const s = e[t];
      let i;
      for (i = t - 1; i >= 0 && !(e[i].aabb.lowerBound.y <= s.aabb.lowerBound.y); i--)
        e[i + 1] = e[i];
      e[i + 1] = s;
    }
    return e;
  ...
  static insertionSortZ(e) {
    for (let t = 1, s = e.length; t < s; t++) {
      const s = e[t];
      let i;
      for (i = t - 1; i >= 0 && !(e[i].aabb.lowerBound.z <= s.aabb.lowerBound.z); i--)
        e[i + 1] = e[i];
      e[i + 1] = s;
    }
    return e;
  ...
  sortList() {
    ...
    0 === t
      ? SAPBroadphase.insertionSortX(e)
      : 1 === t
      ? SAPBroadphase.insertionSortY(e)
      : 2 === t && SAPBroadphase.insertionSortZ(e);
  }
  autoDetectAxis() {
    let e = 0,
      t = 0,
...
class Constraint {
  constructor(e, t, s) {
    void 0 === s && (s = {}),
      (s = Utils.defaults(s, { collideConnected: !0, wakeUpBodies: !0 })),
      (this.equations = []),
      (this.bodyA = e),
      (this.bodyB = t),
...
class Equation {
  ...
  computeGiMf() {
    ...
    return (
      o.scale(l, iMfi),
      r.scale(c, iMfj),
      s.invInertiaWorldSolve.vmult(n, invIi_vmult_taui),
      i.invInertiaWorldSolve.vmult(a, invIj_vmult_tauj),
      e.multiplyVectors(iMfi, invIi_vmult_taui) + t.multiplyVectors(iMfj, invIj_vmult_tauj)
    );
  }
  computeGiMGt() {
    const e = this.jacobianElementA,
    ...
    let l = o + n;
    return (
      r.vmult(e.rotational, tmp),
      (l += tmp.dot(e.rotational)),
      a.vmult(t.rotational, tmp),
      (l += tmp.dot(t.rotational)),
      l
    );
  }
  addToWlambda(e) {
...
class ContactEquation extends Equation {
  ...
  computeB(e) {
    ...
    return (
      -g * t - (x * d.dot(y) - x * c.dot(y) + p.dot(l) - h.dot(a)) * s - e * this.computeGiMf()
    );
  }
...
class PointToPointConstraint extends Constraint {
  constructor(e, t, s, i, o) {
    ...
    this.equations.push(n, r, a),
      (n.minForce = r.minForce = a.minForce = -o),
      (n.maxForce = r.maxForce = a.maxForce = o),
      n.ni.set(1, 0, 0),
      r.ni.set(0, 1, 0),
      a.ni.set(0, 0, 1);
  }
  update() {
    const e = this.bodyA,
      ...
      i = this.equationY,
      o = this.equationZ;
    e.quaternion.vmult(this.pivotA, s.ri),
      t.quaternion.vmult(this.pivotB, s.rj),
      i.ri.copy(s.ri),
      i.rj.copy(s.rj),
      o.ri.copy(s.ri),
      o.rj.copy(s.rj);
...
class ConeEquation extends Equation {
  constructor(e, t, s) {
    ...
    super(e, t, -i, i),
      (this.axisA = s.axisA ? s.axisA.clone() : new Vec3(1, 0, 0)),
      (this.axisB = s.axisB ? s.axisB.clone() : new Vec3(0, 1, 0)),
...
class RotationalEquation extends Equation {
  ...
  computeB(e) {
    ...
    i.cross(o, n), o.cross(i, r), a.rotational.copy(r), l.rotational.copy(n);
    return (
      -(Math.cos(this.maxAngle) - i.dot(o)) * t - this.computeGW() * s - e * this.computeGiMf()
    );
  }
}
...
class ConeTwistConstraint extends PointToPointConstraint {
  constructor(e, t, s) {
    ...
    super(
      e,
      s.pivotA ? s.pivotA.clone() : new Vec3(),
      t,
      s.pivotB ? s.pivotB.clone() : new Vec3(),
      i
    ),
      (this.axisA = s.axisA ? s.axisA.clone() : new Vec3()),
      (this.axisB = s.axisB ? s.axisB.clone() : new Vec3()),
      (this.collideConnected = !!s.collideConnected),
      (this.angle = void 0 !== s.angle ? s.angle : 0);
  ...
  update() {
    ...
    super.update(),
      e.vectorToWorldFrame(this.axisA, s.axisA),
      t.vectorToWorldFrame(this.axisB, s.axisB),
      this.axisA.tangents(i.axisA, i.axisA),
      e.vectorToWorldFrame(i.axisA, i.axisA),
      this.axisB.tangents(i.axisB, i.axisB),
      t.vectorToWorldFrame(i.axisB, i.axisB),
      (s.angle = this.angle),
      (i.maxAngle = this.twistAngle);
  }
}
new Vec3(), new Vec3();
class DistanceConstraint extends Constraint {
  constructor(e, t, s, i) {
    void 0 === i && (i = 1e6),
      super(e, t),
      void 0 === s && (s = e.position.distanceTo(t.position)),
      (this.distance = s);
...
class LockConstraint extends PointToPointConstraint {
  constructor(e, t, s) {
    ...
    const i = void 0 !== s.maxForce ? s.maxForce : 1e6,
      ...
      n = new Vec3(),
      r = new Vec3();
    e.position.vadd(t.position, r),
      r.scale(0.5, r),
      t.pointToLocalFrame(r, n),
      e.pointToLocalFrame(r, o),
      super(e, o, t, n, i),
      (this.xA = e.vectorToLocalFrame(Vec3.UNIT_X)),
      (this.xB = t.vectorToLocalFrame(Vec3.UNIT_X)),
      (this.yA = e.vectorToLocalFrame(Vec3.UNIT_Y)),
      (this.yB = t.vectorToLocalFrame(Vec3.UNIT_Y)),
      (this.zA = e.vectorToLocalFrame(Vec3.UNIT_Z)),
      (this.zB = t.vectorToLocalFrame(Vec3.UNIT_Z));
  ...
  update() {
    ...
    super.update(),
      e.vectorToWorldFrame(this.xA, s.axisA),
      t.vectorToWorldFrame(this.yB, s.axisB),
      e.vectorToWorldFrame(this.yA, i.axisA),
      t.vectorToWorldFrame(this.zB, i.axisB),
      e.vectorToWorldFrame(this.zA, o.axisA),
      t.vectorToWorldFrame(this.xB, o.axisB);
  }
}
...
class HingeConstraint extends PointToPointConstraint {
  constructor(e, t, s) {
    ...
    (this.axisB = s.axisB ? s.axisB.clone() : new Vec3(1, 0, 0)).normalize(),
      (this.collideConnected = !!s.collideConnected);
  ...
  update() {
    const e = this.bodyA,
      ...
      l = this.axisB;
    super.update(),
      e.quaternion.vmult(a, n),
      t.quaternion.vmult(l, r),
      n.tangents(i.axisA, o.axisA),
      i.axisB.copy(r),
      o.axisB.copy(r),
      this.motorEquation.enabled &&
        (e.quaternion.vmult(this.axisA, s.axisA), t.quaternion.vmult(this.axisB, s.axisB));
  }
}
...
class Material {
  constructor(e) {
    ...
    'string' == typeof e && ((t = e), (e = {})),
      ...
      (this.restitution = void 0 !== e.restitution ? e.restitution : -1);
  }
}
...
class Spring {
  ...
  applyForce() {
    ...
    r.copy(n),
      r.normalize(),
      o.velocity.vsub(i.velocity, a),
      o.angularVelocity.cross(u, c),
      a.vadd(c, a),
      i.angularVelocity.cross(p, c),
      a.vsub(c, a),
      r.scale(-e * (y - s) - t * a.dot(r), l),
      i.force.vsub(l, i.force),
      o.force.vadd(l, o.force),
      p.cross(l, m),
      u.cross(l, v),
      i.torque.vsub(m, i.torque),
      o.torque.vadd(v, o.torque);
  }
}
...
class WheelInfo {
  ...
  updateWheel(e) {
    ...
    if (this.isInContact) {
      ...
      t.hitPointWorld.vsub(e.position, relpos),
        e.getVelocityAtWorldPoint(relpos, chassis_velocity_at_contactPoint);
...
class RaycastVehicle {
  constructor(e) {
    (this.chassisBody = e.chassisBody),
      ...
      (this.sliding = !1),
      (this.world = null),
      (this.indexRightAxis = void 0 !== e.indexRightAxis ? e.indexRightAxis : 2),
      (this.indexForwardAxis = void 0 !== e.indexForwardAxis ? e.indexForwardAxis : 0),
      (this.indexUpAxis = void 0 !== e.indexUpAxis ? e.indexUpAxis : 1),
      (this.constraints = []),
  ...
  updateVehicle(e) {
    ...
    this.getVehicleAxisWorld(this.indexForwardAxis, o),
      o.dot(i.velocity) < 0 && (this.currentVehicleSpeedKmHour *= -1);
    ...
    for (let o = 0; o < s; o++) {
      ...
      a > s.maxSuspensionForce && (a = s.maxSuspensionForce),
        s.raycastResult.hitNormalWorld.scale(a * e, n),
        s.raycastResult.hitPointWorld.vsub(i.position, r),
        i.applyImpulse(n, r);
    }
    ...
    for (let o = 0; o < s; o++) {
      ...
      (!s.sliding && s.isInContact) ||
        0 === s.engineForce ||
        !s.useCustomSlidingRotationalSpeed ||
        (s.deltaRotation = (s.engineForce > 0 ? 1 : -1) * s.customSlidingRotationalSpeed * e),
        Math.abs(s.brake) > Math.abs(s.engineForce) && (s.deltaRotation = 0),
        (s.rotation += s.deltaRotation),
        (s.deltaRotation *= 0.99);
    }
  }
  updateSuspension(e) {
    ...
    for (let e = 0; e < i; e++) {
      ...
      if (i.isInContact) {
        ...
        let n;
        (n = o < 0 ? i.dampingCompression : i.dampingRelaxation),
          (e -= n * o),
          (i.suspensionForce = e * t),
          i.suspensionForce < 0 && (i.suspensionForce = 0);
      } else i.suspensionForce = 0;
    }
  }
  removeFromWorld(e) {
    this.constraints,
      e.removeBody(this.chassisBody),
      e.removeEventListener('preStep', this.preStepCallback),
      (this.world = null);
  }
  castRay(e) {
    ...
    if (((e.raycastResult.groundObject = 0), c)) {
      ...
      e.suspensionLength < s && (e.suspensionLength = s),
        e.suspensionLength > n && ((e.suspensionLength = n), e.raycastResult.reset());
  ...
  updateWheelTransform(e) {
    ...
    c.copy(o.directionWorld),
      c.scale(o.suspensionLength, c),
      c.vadd(o.chassisConnectionPointWorld, c);
  }
  ...
  updateFriction(e) {
    ...
    for (let e = 0; e < i; e++) {
      const t = s[e];
      t.raycastResult.body && this.numWheelsOnGround++,
        (t.sideImpulse = 0),
        (t.forwardImpulse = 0),
        n[e] || (n[e] = new Vec3()),
        r[e] || (r[e] = new Vec3());
    ...
    for (let e = 0; e < i; e++) {
      ...
      if (a) {
        ...
        l.scale(c, t),
          ...
          l.cross(s, n[e]),
          n[e].normalize(),
          (i.sideImpulse = resolveSingleBilateral(
            o,
            i.raycastResult.hitPointWorld,
            a,
            i.raycastResult.hitPointWorld,
            s
          )),
          (i.sideImpulse *= sideFrictionStiffness2);
      }
    }
    this.sliding = !1;
    for (let t = 0; t < i; t++) {
      ...
      if (((i.slipInfo = 1), r)) {
        const s = 0,
          l = i.brake ? i.brake : s;
        (a = calcRollingFriction(o, r, i.raycastResult.hitPointWorld, n[t], l)),
          (a += i.engineForce * e);
        const c = l / a;
        i.slipInfo *= c;
      }
    ...
    if (this.sliding)
      for (let e = 0; e < i; e++) {
        ...
        0 !== t.sideImpulse &&
          t.skidInfo < 1 &&
          ((t.forwardImpulse *= t.skidInfo), (t.sideImpulse *= t.skidInfo));
      }
    for (let e = 0; e < i; e++) {
      const t = s[e],
        i = new Vec3();
      ...
      if (0 !== t.sideImpulse) {
        ...
        const a = new Vec3();
        r[e].scale(t.sideImpulse, a),
          o.vectorToLocalFrame(i, i),
          (i['xyz'[this.indexUpAxis]] *= t.rollInfluence),
          o.vectorToWorldFrame(i, i),
          o.applyImpulse(a, i),
          a.scale(-1, a),
          s.applyImpulse(a, n);
      }
...
function calcRollingFriction(e, t, s, i, o) {
  ...
  return (
    (n =
      -i.dot(c) * (1 / (computeImpulseDenominator(e, s, i) + computeImpulseDenominator(t, s, i)))),
    o < n && (n = o),
    n < -o && (n = -o),
    n
  );
...
class Sphere extends Shape {
  constructor(e) {
    if (
      (super({ type: Shape.types.SPHERE }), (this.radius = void 0 !== e ? e : 1), this.radius < 0)
    )
...
class RigidVehicle {
  constructor(e) {
    void 0 === e && (e = {}),
      ...
      (this.coordinateSystem =
        void 0 !== e.coordinateSystem ? e.coordinateSystem.clone() : new Vec3(1, 2, 3)),
      e.chassisBody
        ? (this.chassisBody = e.chassisBody)
  ...
  addWheel(e) {
    let t;
    void 0 === e && (e = {}),
      (t = e.body ? e.body : new Body({ mass: 1, shape: new Sphere(1.2) })),
    ...
    const n = new HingeConstraint(this.chassisBody, t, {
      pivotA: s,
      axisA: o,
      pivotB: Vec3.ZERO,
      axisB: o,
  ...
  update() {
    ...
    for (let t = 0; t !== e; t++) {
      ...
      for (let p = 0; p !== d; p++) {
        ...
        (s =
          -d.mass *
          (this.pressures[t] / (this.densities[t] * this.densities[t] + i) +
            this.pressures[p] / (this.densities[p] * this.densities[p] + i))),
          this.gradw(a, r),
          r.scale(s, r),
          o.vadd(r, o),
          d.velocity.vsub(e.velocity, l),
          l.scale(
            (1 / (1e-4 + this.densities[t] * this.densities[p])) * this.viscosity * d.mass,
            l
          ),
          (c = this.nablaw(u)),
          l.scale(c, l),
...
class Cylinder extends ConvexPolyhedron {
  constructor(e, t, s, i) {
    ...
    const o = i,
      ...
      h = Math.cos,
      d = Math.sin;
    n.push(new Vec3(-t * d(0), 0.5 * -s, t * h(0))),
      l.push(0),
      n.push(new Vec3(-e * d(0), 0.5 * s, e * h(0))),
      c.push(1);
    for (let i = 0; i < o; i++) {
      const p = ((2 * Math.PI) / o) * (i + 1),
        u = ((2 * Math.PI) / o) * (i + 0.5);
      i < o - 1
        ? (n.push(new Vec3(-t * d(p), 0.5 * -s, t * h(p))),
          l.push(2 * i + 2),
          n.push(new Vec3(-e * d(p), 0.5 * s, e * h(p))),
          c.push(2 * i + 3),
          a.push([2 * i, 2 * i + 1, 2 * i + 3, 2 * i + 2]))
        : a.push([2 * i, 2 * i + 1, 1, 0]),
        (o % 2 == 1 || i < o / 2) && r.push(new Vec3(-d(u), 0, h(u)));
    }
    a.push(l), r.push(new Vec3(0, 1, 0));
    const p = [];
    for (let e = 0; e < c.length; e++) p.push(c[c.length - e - 1]);
    a.push(p),
      super({ vertices: n, faces: a, axes: r }),
...
class Plane extends Shape {
  ...
  calculateWorldAABB(e, t, s, i) {
    ...
    s.set(-o, -o, -o),
      i.set(o, o, o),
      1 === tempNormal.x ? (i.x = e.x) : -1 === tempNormal.x && (s.x = e.x),
      1 === tempNormal.y ? (i.y = e.y) : -1 === tempNormal.y && (s.y = e.y),
      1 === tempNormal.z ? (i.z = e.z) : -1 === tempNormal.z && (s.z = e.z);
  }
  updateBoundingSphereRadius() {
    this.boundingSphereRadius = Number.MAX_VALUE;
  }
...
class Heightfield extends Shape {
  ...
  getIndexOfPosition(e, t, s, i) {
    ...
    return (
      ...
      i &&
        ...
        a >= n[0].length - 1 && (a = n[0].length - 1)),
      !(r < 0 || a < 0 || r >= n.length - 1 || a >= n[0].length - 1)
    );
  }
  getTriangleAt(e, t, s, i, o, n) {
    ...
    const c = this.data;
    s &&
      ((a = Math.min(c.length - 2, Math.max(0, a))),
      (l = Math.min(c[0].length - 2, Math.max(0, l))));
  ...
  getHeightAt(e, t, s) {
    ...
    let l = a[0],
      c = a[1];
    s &&
      ((l = Math.min(i.length - 2, Math.max(0, l))),
      (c = Math.min(i[0].length - 2, Math.max(0, c))));
    ...
    return h
      ? i[l + 1][c + 1] * d.x + i[l][c + 1] * d.y + i[l + 1][c] * d.z
      : i[l][c] * d.x + i[l + 1][c] * d.y + i[l][c + 1] * d.z;
  }
  ...
  getTriangle(e, t, s, i, o, n) {
    const r = this.data,
      a = this.elementSize;
    s
      ? (i.set((e + 1) * a, (t + 1) * a, r[e + 1][t + 1]),
        o.set(e * a, (t + 1) * a, r[e][t + 1]),
        n.set((e + 1) * a, t * a, r[e + 1][t]))
      : (i.set(e * a, t * a, r[e][t]),
        o.set((e + 1) * a, t * a, r[e + 1][t]),
        n.set(e * a, (t + 1) * a, r[e][t + 1]));
  }
  getConvexTrianglePillar(e, t, s) {
    ...
    const l = i.vertices,
      c =
        (Math.min(n[e][t], n[e + 1][t], n[e][t + 1], n[e + 1][t + 1]) - this.minValue) / 2 +
        this.minValue;
    s
  ...
  calculateWorldAABB(e, t, s, i) {
    s.set(-Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE),
  ...
  setHeightsFromImage(e, t) {
    ...
    for (let e = 0; e < a.height; e++) {
      ...
      for (let o = 0; o < a.width; o++) {
        const n =
          ((a.data[4 * (e * a.height + o)] +
            a.data[4 * (e * a.height + o) + 1] +
            a.data[4 * (e * a.height + o) + 2]) /
            4 /
            255) *
          i;
...
function barycentricWeights(e, t, s, i, o, n, r, a, l) {
  (l.x = ((n - a) * (e - r) + (r - o) * (t - a)) / ((n - a) * (s - r) + (r - o) * (i - a))),
    (l.y = ((a - i) * (e - r) + (s - r) * (t - a)) / ((n - a) * (s - r) + (r - o) * (i - a))),
    (l.z = 1 - l.x - l.y);
}
class OctreeNode {
  constructor(e) {
    void 0 === e && (e = {}),
      ...
      (this.aabb = e.aabb ? e.aabb.clone() : new AABB()),
      (this.data = []),
      (this.children = []);
  }
  reset() {
  ...
  subdivide() {
    ...
    for (let e = 0; 8 !== e; e++) {
      ...
      (n.x *= halfDiagonal.x),
        ...
        (n.z *= halfDiagonal.z),
        n.vadd(t, n),
        n.vadd(halfDiagonal, s.aabb.upperBound);
    }
  }
  aabbQuery(e, t) {
    ...
    for (; s.length; ) {
      const i = s.pop();
      i.aabb.overlaps(e) && Array.prototype.push.apply(t, i.data),
        Array.prototype.push.apply(s, i.children);
    }
    return t;
  }
  rayQuery(e, t, s) {
...
class Octree extends OctreeNode {
  constructor(e, t) {
    void 0 === t && (t = {}),
      super({ root: null, aabb: e }),
      (this.maxDepth = void 0 !== t.maxDepth ? t.maxDepth : 8);
  }
}
...
class Trimesh extends Shape {
  ...
  updateTree() {
    ...
    for (let t = 0; t < this.indices.length / 3; t++) {
      const a = 3 * t;
      this._getUnscaledVertex(this.indices[a], i),
        this._getUnscaledVertex(this.indices[a + 1], o),
        this._getUnscaledVertex(this.indices[a + 2], n),
        s.setFromPoints(r),
        e.insert(s, t);
    }
    e.removeEmptyNodes();
  ...
  updateNormals() {
    ...
    for (let s = 0; s < this.indices.length / 3; s++) {
      ...
      this.getVertex(o, va),
        this.getVertex(n, vb),
        this.getVertex(r, vc),
        Trimesh.computeNormal(vb, va, vc, e),
        (t[i] = e.x),
        (t[i + 1] = e.y),
        (t[i + 2] = e.z);
    }
  ...
  getTriangleVertices(e, t, s, i) {
    const o = 3 * e;
    this.getVertex(this.indices[o], t),
      this.getVertex(this.indices[o + 1], s),
      this.getVertex(this.indices[o + 2], i);
  }
  getNormal(e, t) {
    const s = 3 * e;
  ...
  calculateLocalInertia(e, t) {
    ...
    return t.set(
      (1 / 12) * e * (2 * i * 2 * i + 2 * o * 2 * o),
      (1 / 12) * e * (2 * s * 2 * s + 2 * o * 2 * o),
      (1 / 12) * e * (2 * i * 2 * i + 2 * s * 2 * s)
    );
  }
  computeLocalAABB(e) {
    ...
    for (let e = 0; e !== i; e++)
      this.getVertex(e, o),
        o.x < t.x ? (t.x = o.x) : o.x > s.x && (s.x = o.x),
        o.y < t.y ? (t.y = o.y) : o.y > s.y && (s.y = o.y),
        o.z < t.z ? (t.z = o.z) : o.z > s.z && (s.z = o.z);
  }
  updateAABB() {
    ...
    if (0 !== r) {
      ...
      for (s = 0; s !== i; s++) {
        ...
        for (let e = 0; e !== r; e++) {
          ...
          (h = g[e]),
            ...
            (m = t.computeGWlambda()),
            (p = d * (h - m - t.eps * v)),
            v + p < t.minForce ? (p = t.minForce - v) : v + p > t.maxForce && (p = t.maxForce - v),
            (x[e] += p),
            (u += p > 0 ? p : -p),
            t.addToWlambda(p);
        }
      ...
      for (let e = 0; e !== l; e++) {
        const t = a[e],
          s = t.velocity,
          i = t.angularVelocity;
        t.vlambda.vmul(t.linearFactor, t.vlambda),
          s.vadd(t.vlambda, s),
          t.wlambda.vmul(t.angularFactor, t.wlambda),
          i.vadd(t.wlambda, i);
      }
      let e = n.length;
      const t = 1 / c;
...
class Narrowphase {
  ...
  createContactEquation(e, t, s, i, o, n) {
    ...
    this.contactPointPool.length
      ...
      : (r = new ContactEquation(e, t)),
      (r.enabled =
        e.collisionResponse && t.collisionResponse && s.collisionResponse && i.collisionResponse);
    const a = this.currentContactMaterial;
    (r.restitution = a.restitution),
      r.setSpookParams(a.contactEquationStiffness, a.contactEquationRelaxation, this.world.dt);
    ...
    return (
      l &&
        ...
        l.restitution >= 0 &&
        c.restitution >= 0 &&
        (r.restitution = l.restitution * c.restitution),
      (r.si = o || s),
      (r.sj = n || i),
      r
    );
  ...
  createFrictionEquationsFromContact(e, t) {
    ...
    if ((c && h && c.friction >= 0 && h.friction >= 0 && (l = c.friction * h.friction), l > 0)) {
      ...
      return (
        (h.bi = d.bi = s),
        (h.bj = d.bj = i),
        (h.minForce = d.minForce = -o * n),
        (h.maxForce = d.maxForce = o * n),
        h.ri.copy(e.ri),
        h.rj.copy(e.rj),
        d.ri.copy(e.ri),
        d.rj.copy(e.rj),
        e.ni.tangents(h.t, d.t),
        h.setSpookParams(a.frictionEquationStiffness, a.frictionEquationRelaxation, r.dt),
        d.setSpookParams(a.frictionEquationStiffness, a.frictionEquationRelaxation, r.dt),
        (h.enabled = d.enabled = e.enabled),
        t.push(h, d),
        !0
      );
    }
  ...
  createFrictionFromAverage(e) {
    ...
    t.bj;
    for (let s = 0; s !== e; s++)
      (t = this.result[this.result.length - 1 - s]),
        t.bi !== o
          ? (averageNormal.vadd(t.ni, averageNormal),
            averageContactPointA.vadd(t.ri, averageContactPointA),
            averageContactPointB.vadd(t.rj, averageContactPointB))
          : (averageNormal.vsub(t.ni, averageNormal),
            averageContactPointA.vadd(t.rj, averageContactPointA),
            averageContactPointB.vadd(t.ri, averageContactPointB));
    const n = 1 / e;
    averageContactPointA.scale(n, s.ri),
      averageContactPointB.scale(n, s.rj),
      i.ri.copy(s.ri),
      i.rj.copy(s.rj),
      averageNormal.normalize(),
      averageNormal.tangents(s.t, i.t);
  }
  getContacts(e, t, s, i, o, n, r) {
    ...
    for (let i = 0, o = e.length; i !== o; i++) {
      ...
      const d =
        (o.type & Body.KINEMATIC && n.type & Body.STATIC) ||
        (o.type & Body.STATIC && n.type & Body.KINEMATIC) ||
        (o.type & Body.KINEMATIC && n.type & Body.KINEMATIC);
      for (let e = 0; e < o.shapes.length; e++) {
        o.quaternion.mult(o.shapeOrientations[e], a),
          o.quaternion.vmult(o.shapeOffsets[e], c),
          c.vadd(o.position, c);
        const t = o.shapes[e];
        for (let e = 0; e < n.shapes.length; e++) {
          n.quaternion.mult(n.shapeOrientations[e], l),
            n.quaternion.vmult(n.shapeOffsets[e], h),
            h.vadd(n.position, h);
          const i = n.shapes[e];
          if (
            !(
              t.collisionFilterMask & i.collisionFilterGroup &&
              i.collisionFilterMask & t.collisionFilterGroup
            )
          )
            continue;
          if (c.distanceTo(h) > t.boundingSphereRadius + i.boundingSphereRadius) continue;
          let p = null;
          t.material && i.material && (p = s.getContactMaterial(t.material, i.material) || null),
            (this.currentContactMaterial = p || r || s.defaultContactMaterial);
          const u = this[t.type | i.type];
          if (u) {
            let e = !1;
            (e =
              t.type < i.type
                ? u.call(this, t, i, c, h, a, l, o, n, t, i, d)
                : u.call(this, i, t, h, c, l, a, n, o, t, i, d)),
              e && d && (s.shapeOverlapKeeper.set(t.id, i.id), s.bodyOverlapKeeper.set(o.id, n.id));
          }
        }
      }
    }
  ...
  spherePlane(e, t, s, i, o, n, r, a, l, c, h) {
    ...
    if (
      ...
      s.vsub(i, point_on_plane_to_sphere),
      d.ni.scale(d.ni.dot(point_on_plane_to_sphere), plane_to_sphere_ortho),
      point_on_plane_to_sphere.vsub(plane_to_sphere_ortho, d.rj),
      -point_on_plane_to_sphere.dot(d.ni) <= e.radius)
    ) {
      if (h) return !0;
      const e = d.ri,
        t = d.rj;
    ...
    for (let e = 0, t = p.length; e !== t && !1 === m; e++) {
      ...
      if (i < s + u && i > 0) {
        ...
        if (l < r && l > -r && c < a && c > -a) {
          ...
          if (
            (null === _ || e < _) &&
            ((_ = e), (w = l), (b = c), (x = s), v.copy(t), y.copy(o), g.copy(n), f++, h)
          )
            return !0;
        }
      }
    ...
    for (let o = 0; 2 !== o && !m; o++)
      for (let n = 0; 2 !== n && !m; n++)
        for (let d = 0; 2 !== d && !m; d++)
          if (
            (B.set(0, 0, 0),
            o ? B.vadd(p[0], B) : B.vsub(p[0], B),
            n ? B.vadd(p[1], B) : B.vsub(p[1], B),
            d ? B.vadd(p[2], B) : B.vsub(p[2], B),
            i.vadd(B, S),
            S.vsub(s, S),
            S.lengthSquared() < u * u)
          ) {
  ...
  planeBox(e, t, s, i, o, n, r, a, l, c, h) {
    return (
      ...
      this.planeConvex(e, t.convexPolyhedronRepresentation, s, i, o, n, r, a, e, t, h)
    );
  }
  convexConvex(e, t, s, i, o, n, r, a, l, c, h, d, p) {
    ...
    if (
      ...
      e.findSeparatingAxis(t, s, o, i, n, u, d, p)
    ) {
      const d = [],
        p = convexConvex_q;
    ...
    for (let o = 0; o !== m.length; o++) {
      ...
      if ((p.vsub(s, u), u.lengthSquared() < v * v)) {
        ...
        return (
          ...
          o.rj.vsub(a.position, o.rj),
          this.result.push(o),
          void this.createFrictionEquationsFromContact(o, this.frictionResult)
        );
      }
    }
    for (let o = 0, g = u.length; o !== g && !1 === y; o++) {
      ...
      if ((s.vsub(w, S), B < 0 && S.dot(f) > 0)) {
        ...
        for (let p = 0; p !== x.length; p++) {
          const u = d.get(),
            y = d.get();
          n.vmult(m[x[(p + 1) % x.length]], u),
            n.vmult(m[x[(p + 2) % x.length]], y),
            i.vadd(u, u),
            i.vadd(y, y);
  ...
  boxConvex(e, t, s, i, o, n, r, a, l, c, h) {
    return (
      (e.convexPolyhedronRepresentation.material = e.material),
      (e.convexPolyhedronRepresentation.collisionResponse = e.collisionResponse),
      this.convexConvex(e.convexPolyhedronRepresentation, t, s, i, o, n, r, a, e, t, h)
    );
  }
  sphereHeightfield(e, t, s, i, o, n, r, a, l, c, h) {
    ...
    for (let l = y; l < g; l++)
      for (let c = x; c < f; c++) {
        ...
        let p = !1;
        if (
          (t.getConvexTrianglePillar(l, c, !1),
          Transform.pointToWorldFrame(i, n, t.pillarOffset, m),
          s.distanceTo(m) < t.pillarConvex.boundingSphereRadius + e.boundingSphereRadius &&
            (p = this.sphereConvex(e, t.pillarConvex, s, m, o, n, r, a, e, t, h)),
          h && p)
        )
          return !0;
        if (
          (t.getConvexTrianglePillar(l, c, !0),
          Transform.pointToWorldFrame(i, n, t.pillarOffset, m),
          s.distanceTo(m) < t.pillarConvex.boundingSphereRadius + e.boundingSphereRadius &&
            (p = this.sphereConvex(e, t.pillarConvex, s, m, o, n, r, a, e, t, h)),
          h && p)
  ...
  boxHeightfield(e, t, s, i, o, n, r, a, l, c, h) {
    return (
      (e.convexPolyhedronRepresentation.material = e.material),
      (e.convexPolyhedronRepresentation.collisionResponse = e.collisionResponse),
      this.convexHeightfield(e.convexPolyhedronRepresentation, t, s, i, o, n, r, a, e, t, h)
    );
  }
      ...
      for (let l = g; l < x; l++)
        for (let c = f; c < w; c++) {
          ...
          if (
            ...
            Transform.pointToWorldFrame(i, n, t.pillarOffset, m),
            s.distanceTo(m) < t.pillarConvex.boundingSphereRadius + e.boundingSphereRadius &&
              (d = this.convexConvex(e, t.pillarConvex, s, m, o, n, r, a, null, null, h, v, null)),
            h && d)
          )
            return !0;
          if (
  ...
  boxParticle(e, t, s, i, o, n, r, a, l, c, h) {
    return (
      (e.convexPolyhedronRepresentation.material = e.material),
      (e.convexPolyhedronRepresentation.collisionResponse = e.collisionResponse),
      this.convexParticle(e.convexPolyhedronRepresentation, t, s, i, o, n, r, a, e, t, h)
    );
  }
  ...
  sphereTrimesh(e, t, s, i, o, n, r, a, l, c, h) {
    ...
    Transform.pointToLocalFrame(i, n, s, v);
    const b = e.radius;
    g.lowerBound.set(v.x - b, v.y - b, v.z - b),
      g.upperBound.set(v.x + b, v.y + b, v.z + b),
      t.getTrianglesInAABB(g, w);
    ...
    for (let o = 0; o < w.length; o++)
      for (let g = 0; g < 3; g++) {
        t.getVertex(t.indices[3 * w[o] + g], d),
          t.getVertex(t.indices[3 * w[o] + ((g + 1) % 3)], p),
          p.vsub(d, u),
          v.vsub(p, y);
        const x = y.dot(u);
        v.vsub(d, y);
        ...
        if (f > 0 && x < 0) {
          ...
          if (y.distanceTo(v) < e.radius) {
            ...
            y.vsub(v, o.ni),
              o.ni.normalize(),
              o.ni.scale(e.radius, o.ri),
              o.ri.vadd(s, o.ri),
              o.ri.vsub(r.position, o.ri),
              Transform.pointToWorldFrame(i, n, y, y),
              y.vsub(a.position, o.rj),
              Transform.vectorToWorldFrame(n, o.ni, o.ni),
              Transform.vectorToWorldFrame(n, o.ri, o.ri),
              this.result.push(o),
              this.createFrictionEquationsFromContact(o, this.frictionResult);
          }
        }
    ...
    for (let o = 0, d = w.length; o !== d; o++) {
      ...
      if (
        ...
        v.vsub(y, y),
        (d = y.distanceTo(v)),
        Ray.pointInTriangle(y, S, V, A) && d < e.radius)
      ) {
        if (h) return !0;
        let o = this.createContactEquation(r, a, e, t, l, c);
        y.vsub(v, o.ni),
...
class World extends EventTarget {
  constructor(e) {
    void 0 === e && (e = {}),
      ...
      e.frictionGravity &&
        ((this.frictionGravity = new Vec3()), this.frictionGravity.copy(e.frictionGravity)),
  ...
  step(e, t, s) {
    if ((void 0 === s && (s = 10), void 0 === t)) this.internalStep(e), (this.time += e);
      ...
      for (
        ...
        this.accumulator >= e &&
        o < s &&
        (this.internalStep(e), (this.accumulator -= e), o++, !(performance.now() - i > 1e3 * e));
      ...
      for (let e = 0; e !== this.bodies.length; e++) {
        ...
        t.previousPosition.lerp(t.position, n, t.interpolatedPosition),
          t.previousQuaternion.slerp(t.quaternion, n, t.interpolatedQuaternion),
          t.previousQuaternion.normalize();
      }
      this.time += t;
    }
  }
  internalStep(e) {
    ...
    l && (d = performance.now()),
      ...
      l && (c.broadphase = performance.now() - d);
    let x = p.length;
    for (g = 0; g !== x; g++) {
      const e = p[g];
      if (!e.collideConnected)
        for (let t = s.length - 1; t >= 0; t -= 1)
          ((e.bodyA === s[t] && e.bodyB === i[t]) || (e.bodyB === s[t] && e.bodyA === i[t])) &&
    ...
    for (
      this.frictionEquations.length = 0,
        this.narrowphase.getContacts(s, i, this, t, f, this.frictionEquations, u),
        l && (c.narrowphase = performance.now() - d),
        l && (d = performance.now()),
        g = 0;
      g < this.frictionEquations.length;
      g++
    )
    ...
    for (let e = 0; e !== _; e++) {
      ...
      if (
        ((l =
          (i.material && o.material && this.getContactMaterial(i.material, o.material)) ||
          this.defaultContactMaterial),
        l.friction,
        i.material &&
          o.material &&
          (i.material.friction >= 0 &&
            o.material.friction >= 0 &&
            (i.material.friction, o.material.friction),
          i.material.restitution >= 0 &&
            o.material.restitution >= 0 &&
            (s.restitution = i.material.restitution * o.material.restitution)),
        r.addEquation(s),
        i.allowSleep &&
          i.type === Body.DYNAMIC &&
          i.sleepState === Body.SLEEPING &&
          o.sleepState === Body.AWAKE &&
          o.type !== Body.STATIC)
      ) {
        o.velocity.lengthSquared() + o.angularVelocity.lengthSquared() >=
          2 * o.sleepSpeedLimit ** 2 && (i.wakeUpAfterNarrowphase = !0);
      }
      if (
        o.allowSleep &&
        o.type === Body.DYNAMIC &&
        o.sleepState === Body.SLEEPING &&
        i.sleepState === Body.AWAKE &&
        i.type !== Body.STATIC
      ) {
        i.velocity.lengthSquared() + i.angularVelocity.lengthSquared() >=
          2 * i.sleepSpeedLimit ** 2 && (o.wakeUpAfterNarrowphase = !0);
      }
      this.collisionMatrix.set(i, o, !0),
        this.collisionMatrixPrevious.get(i, o) ||
          ((World_step_collideEvent.body = o),
          (World_step_collideEvent.contact = s),
          i.dispatchEvent(World_step_collideEvent),
          (World_step_collideEvent.body = i),
          o.dispatchEvent(World_step_collideEvent)),
        this.bodyOverlapKeeper.set(i.id, o.id),
        this.shapeOverlapKeeper.set(n.id, a.id);
    }
    for (
      this.emitContactEvents(),
        l && ((c.makeContactConstraints = performance.now() - d), (d = performance.now())),
        g = 0;
      g !== o;
      g++
    ) {
    ...
    this.clearForces(),
      ...
      l && (c.integrate = performance.now() - d),
      (this.stepnumber += 1),
  ...
  emitContactEvents() {
    ...
    if (((e || t) && this.bodyOverlapKeeper.getDiff(additions, removals), e)) {
      for (let e = 0, t = additions.length; e < t; e += 2)
        (beginContactEvent.bodyA = this.getBodyById(additions[e])),
          (beginContactEvent.bodyB = this.getBodyById(additions[e + 1])),
          this.dispatchEvent(beginContactEvent);
      beginContactEvent.bodyA = beginContactEvent.bodyB = null;
    }
    if (t) {
      for (let e = 0, t = removals.length; e < t; e += 2)
        (endContactEvent.bodyA = this.getBodyById(removals[e])),
          (endContactEvent.bodyB = this.getBodyById(removals[e + 1])),
    ...
    if (((s || i) && this.shapeOverlapKeeper.getDiff(additions, removals), s)) {
      for (let e = 0, t = additions.length; e < t; e += 2) {
        ...
        (beginShapeContactEvent.shapeA = t),
          (beginShapeContactEvent.shapeB = s),
          t && (beginShapeContactEvent.bodyA = t.body),
          s && (beginShapeContactEvent.bodyB = s.body),
    ...
    if (i) {
      for (let e = 0, t = removals.length; e < t; e += 2) {
        ...
        (endShapeContactEvent.shapeA = t),
          (endShapeContactEvent.shapeB = s),
          t && (endShapeContactEvent.bodyA = t.body),
          s && (endShapeContactEvent.bodyB = s.body),
