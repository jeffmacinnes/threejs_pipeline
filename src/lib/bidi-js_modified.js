          ...
          if (charTypeCounts.get(TYPE_EN)) {
            for (var si$4 = 0; si$4 < seqIndices$1.length; si$4++) {
              ...
              if (charTypes[i$12] & TYPE_EN) {
                ...
                for (
                  var sj$5 = si$4 + 1;
                  sj$5 < seqIndices$1.length &&
                  charTypes[seqIndices$1[sj$5]] & (TYPE_ET | BN_LIKE_TYPES);
                  sj$5++
                ) {
          ...
          if (
            ...
            for (var si$5 = 0; si$5 < seqIndices$1.length; si$5++) {
              ...
              if (charTypes[i$13] & (TYPE_ET | TYPE_ES | TYPE_CS)) {
                ...
                for (
                  var sj$6 = si$5 - 1;
                  sj$6 >= 0 && charTypes[seqIndices$1[sj$6]] & BN_LIKE_TYPES;
                  sj$6--
                ) {
                ...
                for (
                  var sj$7 = si$5 + 1;
                  sj$7 < seqIndices$1.length && charTypes[seqIndices$1[sj$7]] & BN_LIKE_TYPES;
                  sj$7++
                ) {
            ...
            for (var si$12 = 0; si$12 < seqIndices$1.length; si$12++) {
              if (charTypes[seqIndices$1[si$12]] & NEUTRAL_ISOLATE_TYPES) {
                ...
                for (var sj$8 = niRunStart; sj$8 <= niRunEnd; sj$8++) {
                  charTypes[seqIndices$1[sj$8]] =
                    prevType$2 === nextType$1 ? prevType$2 : getEmbedDirection(seqIndices$1[sj$8]);
                }
                si$12 = niRunEnd;
              }
            }
