...
var t =
  ...
  s = function (s) {
    ...
    -1 != r &&
      -1 != i &&
      (s = s.substring(0, r) + s.substring(r, i).replace(/:/g, ';') + s.substring(i, s.length));
...
function p(t, e) {
  e.useNativeTimers
    ...
    : ((t.setTimeoutFn = setTimeout.bind(i)), (t.clearTimeoutFn = clearTimeout.bind(i)));
}
var u = l;
function l(t) {
  if (t)
  ...
  polling: class extends I {
    constructor(t) {
      if ((super(t), 'undefined' != typeof location)) {
        ...
        s || (s = e ? '443' : '80'),
          (this.xd =
            ('undefined' != typeof location && t.hostname !== location.hostname) || s !== t.port),
          (this.xs = t.secure !== e);
      }
...
class $ extends u {
  constructor(t, e = {}) {
    super(),
      ...
      'string' == typeof this.opts.query && (this.opts.query = D.decode(this.opts.query)),
      (this.id = null),
      (this.upgrades = null),
...
function rt(t, e) {
  ...
  else if ('object' == typeof t) for (const s in t) t.hasOwnProperty(s) && (t[s] = rt(t[s], e));
  return t;
}
const it = 5;
var ot;
...
class yt extends u {
  constructor(t, e) {
    ...
    super(),
      ...
      this.randomizationFactor(null !== (s = e.randomizationFactor) && void 0 !== s ? s : 0.5),
      (this.backoff = new dt({
      ...
      const s = this.setTimeoutFn(() => {
        t.skipReconnect ||
          ...
          t.skipReconnect ||
            t.open((e) => {
              e
                ? ((t._reconnecting = !1), t.reconnect(), this.emitReserved('reconnect_error', e))
                : t.onreconnect();
            }));
      }, e);
      this.opts.autoUnref && s.unref(),
...
export { yt as Manager, lt as Socket, gt as connect, gt as default, gt as io, it as protocol };
